...
public class MF {
    ...
    public MF(BigInteger mfId, String schemeType, String category, String fundHouse, String iSINDivPayoutGrowth, String iSINDivReinvestment, String mfName, BigDecimal nav, java.util.Date date) {
        this.mfId = mfId;
